...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // POSITION: Top center, pushing down slightly
      "fixed top-0 left-1/2 z-[100] flex max-h-screen w-full -translate-x-1/2 flex-col-reverse p-4 sm:p-6 md:max-w-[420px]",
      className
    )}
    {...props}
  />
